...
Currently I'm studying at daffodil International University, Dept. of Computer Science & Engineering (CSE) in 11th semester. I passed my HSC at Bogura Cantonment Public School & College, Bogura. I interested with Computer networking, Natural language processing (NLP), Machine Learning(ML) etc. I did some course about CLI & Shell, Latex, Android Application Development etc. Also did some course in online during corona pandemic likes Python, HTML, CSS, JavaScript, jQuery, PHP, MySQL etc.
